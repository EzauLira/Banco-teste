...
//	}
	...
	// MENU SEGURO
	public static void menuSeguros(Cliente cliente) {
		int numSeguro;
		System.out.println("[1] Ver Seguros\n" + "[2] Rever informações do meu plano \n" + "[3] Acionar seguro\n");
		numSeguro = input.nextInt();

		switch (numSeguro) {
		case 1:
			System.out.println("Seguro Viagem:\n" + "Para clientes comum e super: R$50,00 por mês\n"
					+ "Para clientes premium: incluso no plano\n" + "Seguro de Fraude:\n"
					+ "Cobertura automática para todos os cartões, com um valor de apólice base de R$ 5.000,00\n");
			break;

		case 2:
			if (cliente.getTipoCliente().equals("Premium")) {
				System.out.println(
						"Você é um cliente Premium. Seu plano inclui o Seguro Viagem e o Seguro de Fraude com um valor de apólice base de R$ 5.000,00.");
			} else {
				System.out.println("Você é um cliente " + cliente.getTipoCliente()
						+ ". Seu plano inclui o Seguro de Fraude com um valor de apólice base de R$ 5.000,00. O Seguro Viagem é opcional e custa R$50,00 por mês.");
			}
			break;

		case 3:
			// Aqui você pode adicionar o código para acionar o seguro
			break;
